...
export const environment = {
  ...
  api: "https://servicios-tecno-tst.azurewebsites.net/api/CuentaDNIPremios",
  blob: "https://cta-dni-premios-backtst.azurewebsites.net/api/PaymentReceiptImage",
  // blob:"https://localhost:7080/api/PaymentReceiptImage",
